...
![Education](education_monster.png)
...
| Category | Grade (0-3) | Comments / Justification |
|---|---|---|
| 1. **Don't make me think:** How intuitive was this site? | 3  | The website was pretty intuitive as it basically does what it is supposed to do: help the user find a job. The "above the fold" part of the front page had a huge search bar for the user to search for jobs which was a huge plus if the user only wanted to look for jobs right away. They had popular search terms for jobs right under the search bar for the user to click on so they did not have to type everything out in the search bar.  |
| 2. **Users are busy:** Did this site value your time?  | 3  | The website did value my time as after the pretty short sign up process, I could look for jobs right away and looking up my profile and updating information was not a tough process at all.  |
| 3. **Good billboard design:** Did this site make the important steps and information clear? How or how not? | 2  | When creating and account and when applying for jobs, it was pretty clear what was important and what was needed when going through these steps in this website. I am deducting a point because it has a little more text and images that might be distractions for users.  |
| 4. **Tell me what to do:** Did this site lead you towards a specific, opinionated path? | 3  | As for leading the user when creating an account or applying for a job, this website did it well enough and it does guide the user to do what they want to do. What I liked about this website is the fact that they had an option for career advice that people who are just getting started with applying for jobs would appreciate.  |
| 5. **Omit Words:** How careful was this site with its use of copy? | 1  | While the website offered other resources like career advice and advice on how to get started, there were too many words everywhere for me. ZipRecruiter had everything straight to the point and ready to go while Monster had so many other more potentially unnecessary words around the webpagee.  |
| 6. **Navigation:** How effective was the workflow / navigation of the site? | 2  | While the website generally had good navigation, there was one button that really threw me off. When you are logged in, right next to your profile icon there is a button that is supposed to log you out, however, it did not have any text under it or on it to indicate anything. Normally, logging out of an account would involve clicking on the profile or setting icon to access the log out button or maybe the log out button should be a text instead of an icon. That was the only gripe I had with this website. As for looking up jobs and signing up, this had no problem.  |
| 7. **Accessibility:** How accessible is this site to a screen reader or a mouse-less interface? | 0  | This website gets a bad accessibility rating... None of the images have alt-text in the website.  |
| **TOTAL** | 14  | While the website would be fine for people with no disabilities, it would be a terrible experience for people who have disabilities because it does not cater well towards people with disabilities.  |
...
| Use Case #1 | |
|---|---|
| Title |As a user of the app, I want to create a goal. |
| Description / Steps |1. User logs into the app. </br> 2. User taps on the “goals” tab at the bottom of the screen. </br> 3. User enters the goal and decides what measurements to use and customize the icon/color of the goal. </br> 4. User decides who to share the goal with. </br> 5. User selects the check-in frequency of the application. </br> 6. User taps on the “create” button. |
| Primary Actor |User |
| Preconditions |1. User has to have an account registered with us. </br> 2. User has to be logged in. |
| Postconditions |1. Goal will be added to the user's "goal" tab. </br> 2. Goal will be shared with whichever users the decides to share it with. |
